---
title: Send SMS
description: Send SMS notifications to users via access tokens.
---

`POST /v1/messages/sendSms`

Enables merchants to send SMS messages to users via their access tokens.
...
<ParamField body="templateCode" type="string" required>
  Template identifier for the SMS.
...
|-------------|-----------|-------------|
| `S` | `SUCCESS` | SMS sent successfully |
